...
EMBEDDING_PROGRESS_CHUNK_SIZE = _int_env("EMBEDDING_PROGRESS_CHUNK_SIZE", 8192)
...
# Column indices (0-based) for pandas — only the 5 columns we need
COL_INDICES = {
    "group": 19,           # Группа тем
...
CLASSIFIER_CACHE_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "cache")
...
# Upload / output
UPLOAD_DIR = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "input")
